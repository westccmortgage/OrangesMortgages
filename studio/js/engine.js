...
(function (global) {
  ...
  /* ============================================================
     ...
     ============================================================ */
  var DEFAULT_MARKET = "orange-county";
  var LIMIT_YEAR = 2026;
  ...
  var BRAND_CONFIG = {
    brandName: "Orange Mortgage",
    domain: "orangesmortgages.com",
    logoText: "Orange Mortgage",
    primaryCTA: "See My Strategy",
    poweredByText: "Powered by West Coast Capital Mortgage, Inc.",
    ...
    recipient: "orange@orangesmortgages.com"
  };

  var FORM_CONFIG = {
    formName: "orange-strategy-studio",
    leadSource: "Orange Mortgage Strategy Studio",
    notificationEmail: "orange@orangesmortgages.com"
  };
