...
(function () {
  ...
  var STR = {
    en: {
      ...
      "hero.eyebrow": "🍊 Orange County's Friendly Mortgage Advisor",
      "hero.h1": `Hi, I'm <span class="accent">Orange.</span><br />Home financing made <span class="accent">simple.</span>`,
      "hero.lead": "Smart mortgage guidance for Orange County buyers, homeowners, and investors — without pressure, confusion, or jargon.",
      "hero.ask": "Ask Orange", "hero.estimate": "Estimate My Payment",
      "hero.trust1": "Licensed Mortgage<br />Guidance",
      "hero.trust2": "Local Orange<br />County Focus",
      ...
      "badge.1": "Licensed Mortgage Guidance", "badge.2": "Local Orange County Focus",
      ...
      "areas.h2": "Orange County mortgage help, city by city",
      "areas.p": "From the coast to the canyons, Orange helps families and investors across Orange County. Don't see your city? We almost certainly serve it too.",
      ...
      "foot.brand": "Friendly, local mortgage guidance for Orange County. Ask Orange anytime.",
      "foot.loans": "Loans", "foot.company": "Company", "foot.touch": "Get in touch",
      "foot.about": "About Orange", "foot.ask": "Ask Orange",
      "foot.serving": "Serving Orange County, CA", "foot.hours": "Mon–Sat · 8am–7pm PT",
      ...
      "home.title": "Orange Mortgage — Ask Orange, Your Orange County Mortgage Guide",
      "home.desc": "Ask Orange. Smart, friendly mortgage guidance for Orange County buyers, homeowners, and investors — purchase, refinance, and investment loans, explained without pressure or jargon.",

      /* ---- About page ---- */
      "ab.subEyebrow": "🍊 The (mostly true) story",
      "ab.h1": `Meet <span class="accent">Orange</span>`,
      "ab.lead": "Part citrus, part mortgage guide, fully committed to helping Orange County buy, refinance, and invest with confidence. He's the friendly face of <strong>West Coast Capital Mortgage, Inc.</strong> — here to make home financing simple, smart, and a little more fun.",
    ...
    ru: {
      ...
      "hero.eyebrow": "🍊 Дружелюбный ипотечный консультант округа Ориндж",
      "hero.h1": `Привет, я <span class="accent">Orange.</span><br />Ипотека — это <span class="accent">просто.</span>`,
      "hero.lead": "Умное сопровождение по ипотеке для покупателей, домовладельцев и инвесторов округа Ориндж — без давления, путаницы и сложных терминов.",
      "hero.ask": "Спросить Orange", "hero.estimate": "Рассчитать платёж",
      "hero.trust1": "Лицензированное<br />сопровождение",
      "hero.trust2": "Фокус на округе<br />Ориндж",
      ...
      "badge.1": "Лицензированное сопровождение", "badge.2": "Фокус на округе Ориндж",
      ...
      "areas.h2": "Помощь с ипотекой в округе Ориндж — город за городом",
      "areas.p": "От побережья до каньонов Orange помогает семьям и инвесторам по всему округу Ориндж. Не нашли свой город? Почти наверняка мы работаем и в нём.",
      ...
      "foot.brand": "Дружелюбное местное сопровождение по ипотеке в округе Ориндж. Спросите Orange в любое время.",
      "foot.loans": "Кредиты", "foot.company": "Компания", "foot.touch": "Связаться",
      "foot.about": "Об Orange", "foot.ask": "Спросить Orange",
      "foot.serving": "Обслуживаем округ Ориндж, Калифорния", "foot.hours": "Пн–Сб · 8:00–19:00 PT",
      ...
      "home.title": "Orange Mortgage — Спросите Orange, ваш ипотечный гид по округу Ориндж",
      "home.desc": "Спросите Orange. Умное, дружелюбное сопровождение по ипотеке для покупателей, домовладельцев и инвесторов округа Ориндж — покупка, рефинансирование и инвест-кредиты, объяснённые без давления и сложных терминов.",

      "ab.subEyebrow": "🍊 (Почти правдивая) история",
      "ab.h1": `Знакомьтесь — <span class="accent">Orange</span>`,
      "ab.lead": "Наполовину апельсин, наполовину ипотечный гид, полностью преданный тому, чтобы помочь округу Ориндж покупать, рефинансировать и инвестировать уверенно. Он — дружелюбное лицо <strong>West Coast Capital Mortgage, Inc.</strong> — чтобы сделать ипотеку простой, умной и немного веселее.",
    ...
    es: {
      ...
      "hero.eyebrow": "🍊 Tu asesor hipotecario amigable del Condado de Orange",
      "hero.h1": `Hola, soy <span class="accent">Orange.</span><br />Financiar tu casa, <span class="accent">así de simple.</span>`,
      "hero.lead": "Orientación hipotecaria inteligente para compradores, propietarios e inversionistas del Condado de Orange — sin presión, confusión ni tecnicismos.",
      "hero.ask": "Pregúntale a Orange", "hero.estimate": "Estimar mi pago",
      "hero.trust1": "Orientación hipotecaria<br />con licencia",
      "hero.trust2": "Enfoque local en el<br />Condado de Orange",
      ...
      "badge.1": "Orientación hipotecaria con licencia", "badge.2": "Enfoque local en el Condado de Orange",
      ...
      "areas.h2": "Ayuda hipotecaria en el Condado de Orange, ciudad por ciudad",
      "areas.p": "De la costa a los cañones, Orange ayuda a familias e inversionistas por todo el Condado de Orange. ¿No ves tu ciudad? Casi con seguridad también la atendemos.",
      ...
      "foot.brand": "Orientación hipotecaria local y amigable para el Condado de Orange. Pregúntale a Orange cuando quieras.",
      "foot.loans": "Préstamos", "foot.company": "Empresa", "foot.touch": "Contacto",
      "foot.about": "Sobre Orange", "foot.ask": "Pregúntale a Orange",
      "foot.serving": "Atendiendo el Condado de Orange, CA", "foot.hours": "Lun–Sáb · 8am–7pm PT",
      ...
      "home.title": "Orange Mortgage — Pregúntale a Orange, tu guía hipotecario del Condado de Orange",
      "home.desc": "Pregúntale a Orange. Orientación hipotecaria inteligente y amigable para compradores, propietarios e inversionistas del Condado de Orange — compra, refinanciación e inversión, explicado sin presión ni tecnicismos.",

      "ab.subEyebrow": "🍊 La historia (casi real)",
      "ab.h1": `Conoce a <span class="accent">Orange</span>`,
      "ab.lead": "Mitad cítrico, mitad guía hipotecario, totalmente dedicado a ayudar al Condado de Orange a comprar, refinanciar e invertir con confianza. Es la cara amigable de <strong>West Coast Capital Mortgage, Inc.</strong> — aquí para hacer la hipoteca simple, inteligente y un poco más divertida.",
